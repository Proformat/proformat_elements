...
\Breakdance\ElementStudio\registerElementForEditing(
    "BreakdanceCustomElements\\LinkMediaReveal",
...
class LinkMediaReveal extends \Breakdance\Elements\Element
{
    ...
    static function designControls()
    {
      ...
      "spacing",
       ['type' => 'popout']
        ...
        "Width",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['0' => 'px', '1' => 'rem', '2' => '%', '3' => 'vw'], 'defaultType' => 'px'], 'rangeOptions' => ['min' => 1, 'max' => 600, 'step' => 1]],
        true,
        false,
        [],
      ), c(
    ...
    static function contentControls()
    {
        ...
        "Style",
        [],
        ['type' => 'dropdown', 'layout' => 'vertical', 'items' => ['0' => ['text' => 'Style 1', 'value' => 'style1'], '1' => ['text' => 'Style 2', 'value' => 'style2'], '2' => ['text' => 'Style 3', 'value' => 'style3'], '3' => ['text' => 'Style 4', 'value' => 'style4'], '4' => ['text' => 'Style 5', 'value' => 'style5'], '5' => ['text' => 'Style 6', 'value' => 'style6'], '6' => ['text' => 'Style 7', 'value' => 'style7'], '7' => ['text' => 'Style 8', 'value' => 'style8'], '8' => ['text' => 'Style 9', 'value' => 'style9']]],
        false,
        false,
        [],
      )],
    ...
    {
        return ['0' =>  ['title' => 'GSAP','scripts' => ['%%BREAKDANCE_ELEMENTS_PLUGIN_URL%%dependencies-files/gsap@3.8.0/gsap.min.js'],],'1' =>  ['title' => 'Instances Manager','scripts' => [ELEMENTS_HIVE_DIR . 'assets/js/utils/eh_instances_manager.js'],'frontendCondition' => 'return false;',],'2' =>  ['title' => 'Link Media Reveal','scripts' => [ELEMENTS_HIVE_DIR . 'elements/Link_Media_Reveal/assets/js/eh_link_media_reveal.min.js'],],'3' =>  ['title' => 'Init builder','inlineScripts' => ['( function() {
  ...
  containerEl.closest(\'.bde-section\').style.overflowX = \'hidden\'

...
\Breakdance\ElementStudio\registerElementForEditing(
    "BreakdanceCustomElements\\GooeyLink",
...
class GooeyLink extends \Breakdance\Elements\Element
{
    ...
    static function designControls()
    {
      ...
      "lightbox",
       ['type' => 'popout']
        ...
        "Width",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'rangeOptions' => ['min' => 0, 'max' => 100, 'step' => 1], 'unitOptions' => ['types' => ['0' => 'px', '1' => 'rem', '2' => '%', '3' => 'vw'], 'defaultType' => '%']],
        false,
        false,
        [],
      ), c(
        ...
        "Height",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['0' => 'pt']], 'rangeOptions' => ['min' => 0, 'max' => 100, 'step' => 0.5]],
        false,
        false,
        [],
      )],
        ...
        "Scale",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'rangeOptions' => ['min' => 0, 'max' => 5, 'step' => 0.1], 'unitOptions' => ['types' => ['0' => '%']]],
        false,
        false,
        [],
      ), c(
        ...
        "Vertical Offset",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'rangeOptions' => ['min' => 0, 'max' => 100, 'step' => 0.5], 'unitOptions' => ['types' => ['0' => 'pt']]],
        false,
        false,
        [],
      ), c(
    ...
    static function contentControls()
    {
        ...
        "Tag",
        [],
        ['type' => 'dropdown', 'layout' => 'vertical', 'items' => ['0' => ['value' => 'h1', 'text' => 'H1'], '1' => ['text' => 'H2', 'value' => 'h2'], '2' => ['text' => 'H3', 'value' => 'h3'], '3' => ['text' => 'H4', 'value' => 'h4'], '4' => ['text' => 'H5', 'value' => 'h5'], '5' => ['text' => 'H6', 'value' => 'h6'], '6' => ['text' => 'Span', 'value' => 'span']], 'condition' => ['path' => 'content.content.enclose_anchor_in_tag', 'operand' => 'is set', 'value' => '']],
        false,
        false,
        [],
      )],
        ...
        "Type",
        [],
        ['type' => 'dropdown', 'layout' => 'vertical', 'items' => ['0' => ['text' => 'Shift Right', 'value' => 'shift-right'], '1' => ['text' => 'Shift Left', 'value' => 'shift-left'], '2' => ['text' => 'Shift Up', 'value' => 'shift-up'], '3' => ['text' => 'Shift Down', 'value' => 'shift-down']]],
        false,
        false,
        [],
      ), c(
        ...
        "Duration",
        [],
        ['type' => 'unit', 'layout' => 'vertical', 'rangeOptions' => ['min' => 0, 'max' => 5, 'step' => 0.1], 'unitOptions' => ['types' => ['0' => 's'], 'defaultType' => 's']],
        false,
        false,
        [],
      ), c(
    ...
    {
        return ['0' =>  ['scripts' => ['%%BREAKDANCE_ELEMENTS_PLUGIN_URL%%dependencies-files/gsap@3.8.0/gsap.min.js'],'title' => 'Gsap',],'1' =>  ['title' => 'Instances Manager','scripts' => [ELEMENTS_HIVE_DIR . 'assets/js/utils/eh_instances_manager.js'],'frontendCondition' => 'return false;',],'2' =>  ['title' => 'Gooey Link','scripts' => [ELEMENTS_HIVE_DIR . 'elements/Gooey_Link/assets/js/eh_gooey_link.min.js'],],'3' =>  ['inlineScripts' => ['( () => {
